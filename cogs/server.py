...
class Server(commands.Cog):
    ...
    async def welcome(self, ctx: commands.Context, id=None):
        if id == None:
            ...
            await ctx.send("Successfully done welcome channel setup in " +
                           "<#" + id + ">")
    ...
    async def leave(self, ctx: commands.Context, id=None):
        if id == None:
            ...
            await ctx.send("Successfully done Leave channel setup in " + "<#" +
                           id + ">")
    ...
    async def lockdownnone(self,
        ...
        elif (channel.overwrites[ctx.guild.default_role].send_messages == True
              or channel.overwrites[ctx.guild.default_role].send_messages
              == None):
            await ctx.send(f"<#{channel.id}>  is on lockdown now")
