...
async def home_page():
    embedVar = discord.Embed(title="Command prefix : `p!`  or `mention me`\n",
                             description="<a:dc9100:860589083938783254>"+" **Misc - 10 : **\n" + "`user`" + "," + "`avatar`" + "," + "`btc`" + "," + "`ping`" + "," + "`timer <seconds>`" + ","
                                         + "`clear <amount>`" + "," + "`uptime`" + "," + "`vote`"
...
async def sample_page():
    embedVar = discord.Embed(title="<a:dc9100:860589083938783254>"+ " Misc",
...
async def economy_page():
    embedVar = discord.Embed(title="<a:economy9100:860587342556037130>" + " Economy",
...
async def mining_page():
    embedVar = discord.Embed(title="<a:hammer9100:860049001960964126>" + " Mining",
...
async def mod_page():
    embedVar = discord.Embed(title="<a:warn9100:860049001717825548>" + " Mod",
...
async def admin_page():
    embedVar = discord.Embed(title="<a:admin9100:872740437893468180>"+ " Admin",
...
async def info_page():
    embedVar = discord.Embed(title="<a:info9100:873577144016592908>"+ " INFO",
                             description="`phn <number_with_countrycode>` - send this in bot dm to know number details \n" + "`serverinfo` - server information\n" + "`botinfo` - Bot information\n" +  "\n\n"
                             , color=0xFF5733,
                             timestamp=datetime.datetime.utcnow()
...
class Help(commands.Cog):
    ...
    async def help(self, ctx: commands.context):
        ...
        paginationList = [hm_page, sm_page,b_page, ad_page,e_page,m_page,md_page,i_page]
        ...
        while True:
            ...
            try:
                interaction = await self.client.wait_for(
                    "button_click",
                    check=lambda i: i.component.id in ["back", "front"] and check,  # You can add more
                    timeout=30.0
                )
